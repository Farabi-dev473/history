...
const transactionIds = Object.keys(JSON.parse(fs.readFileSync(process.cwd() + '/src/test/data.json', 'utf-8')))
const store = new Store({path: process.cwd() + '/src/test/data.json'})
