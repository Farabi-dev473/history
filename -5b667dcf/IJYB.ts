...
import { HoldingRequirement, Role, Winner } from '../schema/TwitterSpace';
...
export class TwitterSpaceGiveawayResolver {
  ...
  async initGiveaway(
    ...
    @Arg('holdingRequirements', () => [HoldingRequirement])
    ...
    try {
      ...
      if (state === 'Running' || state === 'NotStarted') {
        ...
        let newHoldingRequirements: HoldingRequirement[] = [];
