...
const TwitterLogin = ({registered}) => {
  ...
  return (
    <a href={authContext.state.walletAddress ? process.env.TWITTER_ACCOUNT_LINK_REDIRECT_URL :"https://twitter.com/i/oauth2/authorize?response_type=code&client_id=Yy1TdURrTXVmc21xc240U2c1bW06MTpjaQ&redirect_uri=http://localhost:3000/login&scope=tweet.read%20users.read%20follows.read%20offline.access&state=state&code_challenge=challenge&code_challenge_method=plain"}>
