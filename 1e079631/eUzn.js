...
const fn = async() => {
    ...
    for(let i = 1; i <= 100; i++) {
      await prisma.reviewReply.create({
        data: {
            ...
            reviewId: faker.datatype.number({min: 1, max: 300}),
    ...
    //     data: {
    //         ratingStar: faker.datatype.number({min: 1, max: 5}),
    ...
    // await prisma.productsOnCategories.create({
    //     data: {
    ...
    //     data: {
    //         lowestPrice: faker.datatype.float(),
    //         priceChange: faker.datatype.float({min: 1, max: 10}),
    //         productId: faker.datatype.number({min: 1, max: 20}),
    //         shopId: faker.datatype.number({min: 1, max: 5}),
    //         specialDayId: faker.datatype.number({min: 1, max: 10}),
    //     }
    // })

    // await prisma.shopPaymentsOnDeliveries.create({
    //     data: {
    //         deliveryId: faker.datatype.number({min: 1, max: 10}),
