...
import { DiscordExchangeCodeResponse } from '../types';
...
export class AccountLinkingResolver {
  ...
  async linkDiscord(
    ...
    let tokenResponseData = {} as unknown as DiscordExchangeCodeResponse;
  ...
  async loginDiscord(
    ...
    console.log(code, "HEEH")
    // exchange discord authorization code
    const tokenResponseData: DiscordExchangeCodeResponse =
      await exchangeDiscordCode(code, true);
