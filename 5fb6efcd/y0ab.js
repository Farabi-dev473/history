...
const extractAdditionalDataFromTx = (txId) => {
    ...
    const {accounts} = getInstructionData(tx, txType)
...
console.log(extractAdditionalDataFromTx("65GBRLNkRcuSr8JkgFg1xJuMRqWLTXd87uv2bxLvEq1TgY2MdiLtqtEqNRxqaSPuyMASJoaxP4Z9sdFZ67UGHhYF"))