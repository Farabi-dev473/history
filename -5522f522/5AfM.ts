...
const messageCreateHandler =  async (message: Message | {author: string, category: string}) => {
    ...
    try {
      ...
      let entities = isGraphQLRequest ? [message.] : extractStringInsideCurlyBraces((message as Message).content)
