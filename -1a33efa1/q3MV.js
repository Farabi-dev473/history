        ...
        <div>
          {
            holdingRequirements.map((requirement) => {
              ...
              return <HoldingRequirment numOfNFT={requirement.numOfNFT} collection={requirement.collection} trait={requirement.trait} key={requirement.id} dataId={requirement.id} handleOnChange={handleOnChange} handleOnClick={handleOnClick}/>
            })
          }
        </div>
