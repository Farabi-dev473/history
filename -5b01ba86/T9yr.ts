...
const txId = "2B3vSpRNKZZWu2Td1YeRbKeKFhn8XS72YcaAHbHbF2H9n2J"
const programId = "M2mx93ekt1fmXSVkTrUL9xVFHkmME8HTUi5Cyc5aF7K"

// const data = PublicKey.findProgramAddressSync(Buffer.from(bs58.decode(txId)), new PublicKey(programId))
console.log(bs58.decode(txId))