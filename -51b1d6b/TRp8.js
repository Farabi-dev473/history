...
const userResponse = await fetch('https://api.twitter.com/2/users/me', {
  method: 'GET',
  headers: {
    'Authorization': `Bearer ${eJeF1O6iHv9WpBlthMe9EET7M}`
  }
})
...
fetch('https://api.twitter.com/oauth2/token', {
  ...
  headers: {
    'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8',
    'Authorization': `Basic ${btoa(`${twitterApiKey}:${twitterApiSecretKey}`)}`,
  },
  ...
  .then(data => {
    ...
    fetch(`https://api.twitter.com/2/users/${twitterUserId}`, {
      headers: {
      ...
      .then(data => {
        ...
        // Step 3: Handle the user details
        console.log(data)
        // ... etc.
      });
  });
