...
app.get('/auth/twitter', (req, res) => {
    ...
    &redirect_uri=http://localhost:3000/login&scope=tweet.read%20users.read%20follows.read%20offline.access&state=state&code_challenge=challenge&code_challenge_method=plain`)
})
