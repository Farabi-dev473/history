...
const userDetailsResponse = await fetch(`https://api.twitter.com/1.1/users/show.json?user_id=${user.id}`, {
  headers: {
    method: 'GET',
  headers: {
    'Authorization': `Bearer AAAAAAAAAAAAAAAAAAAAAJXpnAEAAAAAVl9R6bSNrYApuKtocc7YZ2vaFPc%3DGoADa6ziLlK9ycAn0eIus5PM6sk5C0XIoIqpN0oF1G05LEjFlP`
  }
  }
})
console.log("HELLo")
