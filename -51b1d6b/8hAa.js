...
const userDetailsResponse = await fetch(`https://api.twitter.com/1.1/users/show.json`, {
  method: 'GET',
  headers: {
    'authorization': 'Bearer AAAAAAAAAAAAAAAAAAAAAJXpnAEAAAAA8i9CNBmX9GOVecN0P2lv32p8OkA%3D0FsYvAweLODGOG5BE9zBOk5LsJEUP8WXQ8gFJDPnRN3TDiFK1e'
  }
})
console.log("HELLo")
