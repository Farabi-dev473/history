...
const getAccounts = (tx) => {
    ...
    instructions.reduce((acc, {accounts, programId, data}) => {
...
console.log(getAccounts(store.get("44JE5GMpWkNEtMUdrBTMVVkPQBdvCrZSjxZzc24yHgij6FPSEKQZt2o6A58Hap9BQbdgrhLmvqqK3c7NPJ4EAC1Y")))
