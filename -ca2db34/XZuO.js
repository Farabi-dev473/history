    ...
    await page.evaluate(() => {
        ...
        while(!done) {
            for(column; column <= 4; column++) {
                result = document.querySelector(`#layers > div:nth-child(2) > div > div > div > div > div.css-1dbjc4n.r-1q9bdsx.r-13qz1uu > div > div > div.css-1dbjc4n.r-13awgt0.r-1pn2ns4 > div > div > div:nth-child(${row}) > div > div:nth-child(${column})`).innerText
                if(result === null) {
                    done = true
                    break
                }
