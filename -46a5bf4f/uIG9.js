...
const getSeller = (tx, programId) =>{ 
  ...
  if(programId === "mmm3XBJg5gk8XJxEKBvdgptZz6SgK4tXvn36sodowMc") {
    ...
    return instructions[0]?.parsed?.info?.source
  }
...
console.log(getSeller(store.get("5QAWR56Ybx2sanHMfpGkbnXnciJAhKuxa7y9LCqYQR4PWrEGyEvUCySykCwzcTqQNFV9JvAUsKu8hwbRSmbB6RVe"), "mmm3XBJg5gk8XJxEKBvdgptZz6SgK4tXvn36sodowMc"))
