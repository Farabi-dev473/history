...
exports.default = {
    [constants_js_1.PROGRAM_IDS.MAGICEDEN_V2]: {
    ...
    [constants_js_1.PROGRAM_IDS.HYPERSPACE]: {
    ...
    [constants_js_1.PROGRAM_IDS.CORALCUBE_AUCTIONHOUSE_2]: {
    ...
    [constants_js_1.PROGRAM_IDS.AUCTIONHOUSE]: {
        identifier: 'AUCTIONHOUSE',
        marketplaceIds: {
            [constants_js_1.PROGRAM_IDS.CORALCUBE]: 'CoralCube',
            [constants_js_1.PROGRAM_IDS.OPENSEA]: 'OpenSea',
        },
        actions: {
    ...
    [constants_js_1.PROGRAM_IDS.SOLANART]: {
        identifier: 'SOLANART',
        actions: {
            List: {
    ...
    [constants_js_1.PROGRAM_IDS.YAWWW]: {
        identifier: 'YAWWW',
        actions: {
            List: {
    ...
    [constants_js_1.PROGRAM_IDS.SOLSEA]: {
        identifier: 'SolSea',
        actions: {
            List: {
    ...
    [constants_js_1.PROGRAM_IDS.SOLSEA_2]: {
        identifier: 'SolSea_2',
        actions: {
            List: {
    ...
    [constants_js_1.PROGRAM_IDS.HADESWAP]: {
        identifier: 'Hadeswap',
        actions: {
            Sale: {
                schemaFields: [
    ...
    [constants_js_1.PROGRAM_IDS.EXCHANGE_ART]: {
    ...
    [constants_js_1.PROGRAM_IDS.TENSOR]: {
        identifier: 'tensor',
        actions: {
            Sale: {
    ...
    [constants_js_1.PROGRAM_IDS.DIGITAL_EYES]: {
    ...
    [constants_js_1.PROGRAM_IDS.MMM]: {
        identifier: 'mmm',
        actions: {
            Sale: {
