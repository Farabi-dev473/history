...
const getTransactionIds = () => {
  return Object.keys(JSON.parse(fs.readFileSync(process.cwd() + '/db.json', 'utf8')));
}
...
// const main = () => {
//   getTransactionIds().forEach(async (txId, index) => {

//       //  if(txId === "value") return
//        const tx = store.get(txId)
//       singleTransactionParser(tx)
//       // console.log(store.get(txId))
//   })
// }

singleTransactionParser("4c9UbAg3YH2Mp9BR2Lyx7vmw1iuiyCJxLJ5XvCHFv3UV59skJpKGPxYsRunBmCF3nLeaixNPxz4BH3gjrHgG98uz")
