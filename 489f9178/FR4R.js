...
import ParseListEventTx from '../src/packages/decoders/List_Event_Parser/ParseListEventTx.js'
let txId, output, result
let ParseListEventTx = new ParseListEventTx()
describe('parseListEventTx', () => {
    ...
    it('should return an object which is equal to `output` - HyperSpace Program', () => {
        const magicEdenParser = new Magic
