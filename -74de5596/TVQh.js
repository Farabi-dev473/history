          ...
          async function fetchCollection() {
           try{
            ...
            if(response.data.status) {
                ...
                setfilteredCollection(collections.map((collection) => collection.name))
            }else{
  ...
  return <div className='text-black'>
     <Combobox value={selectedCollection} onChange={setSelectedCollection}>
      ...
      <Combobox.Options className="text-black">
        {filteredCollection.map(({name: collectionName}) => (
...
function Trait({handleOnChange, id, collectionId}) {
  ...
  return <div className='text-black'>
     <Combobox value={selectedTrait} onChange={setSelectedTrselectedTrait}>
      <Combobox.Input onChange={(event) => setQuery(event.target.value)} />
      <Combobox.Options className="text-black">
      ...
      <div className="bg-gray-200 p-4 rounded-md">
        <div className="flex">
          ...
          <div className="flex-1 ml-4 mb-4">
            ...
            <Trait handleOnChange={handleOnChange} id={dataId} collectionId={collectionId}/>
          </div>
